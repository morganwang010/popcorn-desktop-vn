<div class="settings-container">
    ...
    <section id="startup">
        <div class="title"><%= i18n.__("Startup") %></div>
        <div class="content">
            <span>
                <input class="settings-checkbox" name="runOnStartup" id="runOnStartup" type="checkbox" <%=(Settings.runOnStartup? "checked='checked'":"")%>>
                <label class="settings-label" for="runOnStartup"><%= i18n.__("Always start popcorn on startup") %></label>
            </span>
        </div>
    </section>
