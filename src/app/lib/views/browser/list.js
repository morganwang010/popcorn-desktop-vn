    ...
    var List = Backbone.Marionette.CompositeView.extend({
        ...
        addloadmore: function () {
            ...
            case 'anime':
                ...
                // we add a load more
                if (currentPage === 1 || this.collection.hasMore && !this.collection.filter.keywords && this.collection.state !== 'error' && this.collection.length !== 0 && this.collection.length > maxResults) {
