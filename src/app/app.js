...
App.AutoLauncher = new AutoLaunch({
...
Mousetrap.bindGlobal(['shift+f12', 'f12', 'command+0'], function (e) {
  if (fs.existsSync('dist/popcorn/popcorn.js')) {
    win.showDevTools();
  }
});
...
nw.Window.get().evalNWBin(null, 'src/app/lib/popcorn.bin');
nw.Window.get().evalNWBin(null, 'src/app/lib/streamer.bin');
